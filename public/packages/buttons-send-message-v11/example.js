...
// Application usage: pass onSend({ signal }) and resolve only after the real send action succeeds. Escape cancels a pending request. start(), cancel(), reset() and destroy() are available.
