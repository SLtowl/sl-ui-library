(() => {
  ...
  function mount(root, options = {}) {
    ...
    function render() {
      ...
      text('[data-status]', metric ? 'Metric units selected' : 'Imperial units selected');
    }
