...
// Application usage: pass onPrint({ signal }) and resolve only after the real print action succeeds. Escape cancels a pending request. start(), cancel(), reset() and destroy() are available.
