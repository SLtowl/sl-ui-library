...
import batch15 from './catalog-batches/inputs-basic-2.js';
import batch16 from './catalog-batches/selection-basic-2.js';
export const categories = [
  ...
  { id: 'selection', label: 'Toggles', description: 'On/off switches and segmented selection controls.', keywords: ['switch', 'toggle', 'segment'] },
  { id: 'checkboxes', label: 'Checkboxes', description: 'Checkboxes, radio buttons and grouped choices.', keywords: ['checkbox', 'radio', 'check', 'select'] },
  { id: 'sliders', label: 'Sliders', description: 'Single-value sliders, range selectors and stepped controls.', keywords: ['range', 'volume'] },
  { id: 'menus', label: 'Menus', description: 'Dropdown menus, context menus and command menus.', keywords: ['dropdown', 'context', 'command'] },
...
export const components = [
  {
    ...
    keywords: ['async', 'saving', 'saved', 'confirm', 'confirmation', 'primary', 'secondary'],
  ...
  },
  {
    ...
    keywords: ['clipboard', 'copied', 'text', 'confirmation'],
  ...
  },
  {
    ...
    keywords: ['remove', 'trash', 'deleted', 'destructive'],
  ...
  },
  {
    ...
    keywords: ['file', 'uploading', 'complete', 'progress', 'input'],
  ...
  },
  {
    ...
    keywords: ['link', 'clipboard', 'copy link', 'send', 'sent', 'native share'],
  ...
  },
  {
    ...
    keywords: ['following', 'unfollow', 'person', 'profile', 'toggle'],
...
components.push(...[batch0, batch1, batch2, batch3, batch4, batch5, batch6, batch7, batch8, batch9, batch10, batch11, batch12, batch13, batch14, batch15, batch16].flat());
