...
The generated cover has no component count. The same JPEG was uploaded to the repository's Social preview setting on 2026-09-11; GitHub's public `og:image` now points to the uploaded repository image. Website and repository previews are configured separately. The JPEG is under 1 MB.
